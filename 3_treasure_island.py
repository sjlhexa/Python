...
if choice1 == "left":
  choice2 = input("You've came to a lake. There is an island in the middle of the lake. Type \"wait\" to wait for the boat. Type \"swim\" to swim across.\n").lower()
  if choice2 == "wait":
    ...
    if choice3 == "red":
      ...
      print("You enterd a room of beast. Game Over")
    else:
